...
BOOL CExcelFile::Open(LPCTSTR lpszFileName)
{
	...
	if (m_IsOpen)
		WriteString(_T("From;Dept. time;Dept. gate;To;Arr. time;Arr. gate;Distance;Airline;Flight #;Codeshares;Equipment;Aircraft registration;Aircraft name;Class;Seat;Color;Etix booking code;Fare;Award miles;Status miles;Flags;Rating;Comments\n"));
